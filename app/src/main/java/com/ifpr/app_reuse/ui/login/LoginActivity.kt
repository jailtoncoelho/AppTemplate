package com.ifpr.app_reuse.ui.login
...
import com.ifpr.app_reuse.MainActivity.Companion.usuarioLogado
import com.ifpr.app_reuse.R
import com.ifpr.app_reuse.ui.usuario.CadastroUsuarioActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginButton.setOnClickListener {
            ...
            if (email.isEmpty()) {
                ...
                Toast.makeText(this, "Por favor, insira a sua senha", Toast.LENGTH_SHORT).show()
            } else {
